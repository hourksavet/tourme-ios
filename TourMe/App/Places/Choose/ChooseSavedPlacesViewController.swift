//
//  ChooseSavedPlacesViewController.swift
//  TourMe
//
//  Created by Savet on 18/7/25.
//

import UIKit

class ChooseSavedPlacesViewController: UIViewController {
	...
	init(_ padding: UIEdgeInsets, forChoose: Bool = false) {
	...
	override func loadView() {
		...
		NSLayoutConstraint.activate([
			...
			tableView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -padding.bottom)
		])
	}
	...
	@objc private func getUserPlaces(_ isFavorite: Bool) {
		var settings: NSPredicate!
		if isFavorite {
			settings = NSPredicate(format: "isFavorite = true AND isUserAdd = true")
		}else {
			settings = NSPredicate(format: "isUserAdd = true")
		}
...
extension ChooseSavedPlacesViewController: UITableViewDataSource {
...
extension ChooseSavedPlacesViewController: UITableViewDelegate {
